...
function Testimonials() {
  return (
    <section className="py-12 md:py-16 px-4 md:px-6 bg-teal-50 dark:bg-teal-950">
            ...
            >
              <Card className="hover:shadow-lg transition-all duration-300 h-full">
                <CardContent className="p-4 md:p-5 flex flex-col gap-3">
                  ...
                  {/* Destination tag */}
                  <span className="text-xs bg-teal-50 dark:bg-teal-900 text-teal-600 px-2 py-1 rounded-full w-fit border border-teal-100">
                    ✈️ {t.destination}
                  </span>
